...
// ─────────────────────────────────────────
//  ④ 作物別名・品種名 正規化辞書
//  キー：音声で言いやすい表記 / 品種名 / ひらがな / 漢字
//  値：CROP_DBの正式name（括弧付き含む）
//  vmParseText() がマッチング前にテキストを正規化するために使用。
//  追加は値（CROP_DB name）を確認してから行うこと。
// ─────────────────────────────────────────
const VM_CROP_ALIASES = {
  // ── コメ・水稲 ──
  'こめ':'コメ（水稲）', '水稲':'コメ（水稲）', 'うるち米':'コメ（水稲）',
  'もち米':'コメ（水稲）', 'コシヒカリ':'コメ（水稲）', 'ひとめぼれ':'コメ（水稲）',
  'あきたこまち':'コメ（水稲）', 'ゆめぴりか':'コメ（水稲）', 'つや姫':'コメ（水稲）',
  'にこまる':'コメ（水稲）', 'ササニシキ':'コメ（水稲）', 'ヒノヒカリ':'コメ（水稲）',
  'きぬむすめ':'コメ（水稲）', 'はえぬき':'コメ（水稲）', 'サンふじ':'コメ（水稲）',
  // ── 大豆 ──
  'だいず':'大豆', 'ダイズ':'大豆',
  // ── 黒大豆 ──
  'くろまめ':'黒大豆', '黒豆':'黒大豆', 'くろだいず':'黒大豆',
  // ── 小豆 ──
  'あずき':'小豆', 'アズキ':'小豆',
  // ── 小麦 ──
  'こむぎ':'小麦', 'コムギ':'小麦',
  ...
  'そば':'ソバ', '蕎麦':'ソバ',
  // ── ジャガイモ ──
  'じゃがいも':'ジャガイモ', '馬鈴薯':'ジャガイモ', 'ばれいしょ':'ジャガイモ',
  'ポテト':'ジャガイモ', 'メークイン':'ジャガイモ', 'キタアカリ':'ジャガイモ',
  'インカのめざめ':'ジャガイモ', 'とうや':'ジャガイモ',
  // ── サツマイモ ──
  'さつまいも':'サツマイモ', '甘藷':'サツマイモ', 'かんしょ':'サツマイモ',
  'さつま芋':'サツマイモ', '唐芋':'サツマイモ', '紅はるか':'サツマイモ',
  'なると金時':'サツマイモ', 'べにあずま':'サツマイモ',
  // ── 大根 ──
  'だいこん':'大根', 'ダイコン':'大根',
  // ── ニンジン ──
  'にんじん':'ニンジン', '人参':'ニンジン',
  // ── タマネギ ──
  'たまねぎ':'タマネギ', '玉葱':'タマネギ', '玉ねぎ':'タマネギ',
  // ── キャベツ ──
  'きゃべつ':'キャベツ',
  // ── ハクサイ ──
  'はくさい':'ハクサイ', '白菜':'ハクサイ',
  ...
  'ぱぷりか':'パプリカ',
  // ── ホウレンソウ ──
  'ほうれんそう':'ホウレンソウ', 'ほうれん草':'ホウレンソウ', '菠薐草':'ホウレンソウ',
  // ── レタス ──
  'れたす':'レタス',
  // ── ネギ ──
  'ねぎ':'ネギ', '葱':'ネギ', '長ネギ':'ネギ', '長ねぎ':'ネギ',
  // ── ブロッコリー ──
  'ぶろっこりー':'ブロッコリー',
  // ── カボチャ ──
  'かぼちゃ':'カボチャ', '南瓜':'カボチャ',
  ...
  'えだまめ':'エダマメ', '枝豆':'エダマメ',
  // ── アスパラガス ──
  'あすぱらがす':'アスパラガス', 'アスパラ':'アスパラガス',
  // ── サトイモ ──
  'さといも':'サトイモ', '里芋':'サトイモ',
  // ── ヤマノイモ ──
  'やまのいも':'ヤマノイモ（長芋）', '長芋':'ヤマノイモ（長芋）',
  'ながいも':'ヤマノイモ（長芋）', '自然薯':'ヤマノイモ（長芋）', 'じねんじょ':'ヤマノイモ（長芋）',
  // ── トウモロコシ ──
  'とうもろこし':'スイートコーン（青果用）', 'コーン':'スイートコーン（青果用）',
  // ── リンゴ ──
  'りんご':'リンゴ', '林檎':'リンゴ', 'ふじ':'リンゴ', 'つがる':'リンゴ',
  '王林':'リンゴ', 'シナノゴールド':'リンゴ', 'サンふじ':'リンゴ',
  'ジョナゴールド':'リンゴ',
  // ── ミカン ──
  'みかん':'ミカン（温州ミカン）', '蜜柑':'ミカン（温州ミカン）',
  'うんしゅうみかん':'ミカン（温州ミカン）', '温州':'ミカン（温州ミカン）',
  // ── ブドウ ──
  'ぶどう':'ブドウ', '葡萄':'ブドウ', '巨峰':'ブドウ', 'ピオーネ':'ブドウ',
  'デラウェア':'ブドウ', 'シャインマスカット':'ブドウ', 'マスカット':'ブドウ',
  // ── モモ ──
  'もも':'モモ', '桃':'モモ', '白桃':'モモ', '黄桃':'モモ',
  'あかつき':'モモ', '川中島':'モモ',
  // ── ナシ ──
  'なし':'ナシ（日本ナシ）', '梨':'ナシ（日本ナシ）', '二十世紀':'ナシ（日本ナシ）',
  '豊水':'ナシ（日本ナシ）', '幸水':'ナシ（日本ナシ）', '新高':'ナシ（日本ナシ）',
  // ── カキ ──
  'かき':'カキ', '柿':'カキ', '富有':'カキ', '次郎':'カキ', '平核無':'カキ',
  // ── イチゴ ──
  'いちご':'イチゴ', '苺':'イチゴ', 'とちおとめ':'イチゴ', 'あまおう':'イチゴ',
  'さちのか':'イチゴ', '紅ほっぺ':'イチゴ', '章姫':'イチゴ', '女峰':'イチゴ',
  // ── ブルーベリー ──
  'ぶるーべりー':'ブルーベリー',
  // ── 梅 ──
  'うめ':'梅', 'ウメ':'梅', '南高梅':'梅', '白加賀':'梅',
  // ── オウトウ ──
  'さくらんぼ':'オウトウ（サクランボ）', 'サクランボ':'オウトウ（サクランボ）',
  '佐藤錦':'オウトウ（サクランボ）', '紅秀峰':'オウトウ（サクランボ）',
  // ── キウイ ──
  'きうい':'キウイフルーツ', 'キウイ':'キウイフルーツ', 'キウィ':'キウイフルーツ',
  // ── シイタケ ──
  'しいたけ':'シイタケ', '椎茸':'シイタケ',
  // ── ミズナ ──
  'みずな':'ミズナ', '水菜':'ミズナ',
...
// ─────────────────────────────────────────
const VM_AGRI_WORDS = [
  // ※ 作物・野菜・穀物・豆類・花卉はCROP_DBから自動収集（_vmBuildAllowedWords参照）
  // ── 土づくり・圃場 ──
...
function _vmBuildAllowedWords() {
  ...
  // CROP_DBから作物名を自動収集（括弧内外を分割して両方登録）
  if (typeof CROP_DB !== 'undefined' && Array.isArray(CROP_DB)) {
    for (const c of CROP_DB) {
      ...
      if (m) {
        if (m[1].trim()) set.add(m[1].trim());
        if (m[2].trim()) set.add(m[2].trim());
        if (m[3].trim()) set.add(m[3].trim());
      }
    }
  }
  // 別名・品種名辞書のキーも登録語に追加（フィルタリング通過のため）
  Object.keys(VM_CROP_ALIASES).forEach(k => set.add(k));
...
function vmParseText(rawText) {
  ...
  // 長い語から順に置換して部分マッチ衝突を防ぐ
  const _aliasKeys = Object.keys(VM_CROP_ALIASES).sort((a, b) => b.length - a.length);
  let text = stripped;
  for (const alias of _aliasKeys) {
    if (text.includes(alias)) {
      text = text.split(alias).join(VM_CROP_ALIASES[alias]);
    }
  }
